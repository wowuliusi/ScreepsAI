...
interface CreepMemory {role: string, source: string, target: string, statusNow: string}
interface FlagMemory {}
interface RoomMemory {availableEnergy: number, nonstoreEnergy: number}
interface SpawnMemory {busy: boolean}
