...
interface CreepMemory {role: string, source: string, workingType: string, target: string}
interface FlagMemory {}
interface RoomMemory {sourceWorker: { [key: string]: number; }, availableEnergy: number}
