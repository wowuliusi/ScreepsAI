...
interface CreepMemory {role: string, target: string, statusNow: string}
interface FlagMemory {}
interface RoomMemory {childrooms: string[], nonstoreEnergy: number, storeEnergy: number}
interface SpawnMemory {queue: ICreeptask[], waitTime: number}
